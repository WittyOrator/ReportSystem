...
{
	public class DF_MatrixControl : Webb.Reports.ExControls.UI.ExControlDesignerFormBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "DF_MatrixControl";
			this.Load += new System.EventHandler(this.DF_CompactGroupingControl_Load);
			this.Closed += new System.EventHandler(this.DF_MatrixControl_Closed);
		...
		private void DF_MatrixControl_Closed(object sender, System.EventArgs e)
		{
