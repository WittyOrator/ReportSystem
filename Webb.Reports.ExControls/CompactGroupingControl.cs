...
namespace Webb.Reports.ExControls
{
	...
	ToolboxBitmap(typeof(Webb.Reports.ExControls.ResourceManager), "Bitmaps.GroupControl.bmp")]
	public class CompactGroupingControl : ExControl//, IPrintable,IExtendedControl
	{
        ...
        {
            get { return _CompactGroupView.OurBordersSetting; }
            set
            {
                this._CompactGroupView.OurBordersSetting = value;

                if (DesignMode) this._CompactGroupView.UpdateView();
            }
        }   
	
		public bool Matrix    //Added this code at 2009-2-6 11:48:45@Simon
		{
			get{return _CompactGroupView.Matrix;}
			set
			{
				this._CompactGroupView.Matrix = value;
		...
		{
			get{return _CompactGroupView.WidthEnable;}
			set
			{
				this._CompactGroupView.WidthEnable = value;

				if(DesignMode) this._CompactGroupView.UpdateView();
			}
		}
		[Browsable(false)]
		public bool SepTotal    //Added this code at 2009-2-6 11:48:45@Simon
		{
			get{return _CompactGroupView.SepTotal;}
			set
			{
				this._CompactGroupView.SepTotal = value;
		...
		{
			get{return this._CompactGroupView.MatrixDisplay;}
			set
			{
				
				this._CompactGroupView.MatrixDisplay = value;		
