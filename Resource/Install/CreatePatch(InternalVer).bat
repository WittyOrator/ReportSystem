...
set version=Internal 1.3.0.9.001

set winrRarPath="C:\Program Files\WinRAR\Winrar.exe"
set DesignerPatch="%Patchpath%\Interactive Report(%version%)).exe"
set BrowserPatch="%Patchpath%\Interactive Report(Browser)(%version%).exe"
